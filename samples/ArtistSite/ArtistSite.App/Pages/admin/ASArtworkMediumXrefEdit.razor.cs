...
namespace ArtistSite.App.Pages
{
	...
	public partial class ASArtworkMediumXrefEditViewModel : AdminPageBase
	{
		public ArtworkMediumXref ArtworkMediumXref { get; set; } = new ArtworkMediumXref();
		...
		protected override async Task OnInitializedAsync()
		{
				...
				List<BreadcrumbItem> breadcrumbs = new List<BreadcrumbItem>()
				{
						...
						new BreadcrumbItem("List of ArtworkMediumXrefs", "/admin/artworkMediumXrefs"),
						new BreadcrumbItem("Edit ArtworkMediumXref", $"/admin/artworkmediumxrefedit/{ArtworkId}/{MediumId}", disabled: true)
				};
		...
		protected async override Task OnParametersSetAsync()
		{
				...
				try
				{
						...
						{
								if (ArtworkMediumXref == null || ArtworkMediumXref.ArtworkId != ArtworkId || ArtworkMediumXref.MediumId != MediumId)
								{
										var result = await WebApiDataServiceAS.GetArtworkMediumXrefAsync(ArtworkId, MediumId);
										if (result.IsSuccessStatusCode)
										{
												var artworkMediumXref = result.Data;
												...
												{
														ArtworkMediumXref = artworkMediumXref;
												}
										}
								}
						}
		...
		protected async Task OnValidSubmit()
		{
				...
				{
						var result = await WebApiDataServiceAS.UpdateArtworkMediumXrefAsync(ArtworkMediumXref);
						if (result.IsSuccessStatusCode)
						{
								StatusClass = "alert-success";
								Message = "ArtworkMediumXref updated successfully.";
								await SetSavedAsync(true);
						}
						else
						{
