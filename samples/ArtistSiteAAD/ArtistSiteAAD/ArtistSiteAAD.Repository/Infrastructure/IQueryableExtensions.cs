...
using ArtistSiteAAD.Shared.Extensions;
using System;
...
namespace ArtistSiteAAD.Repository.Infrastructure
{
    public static class IQueryableExtensions
    {
        ...
        {
            //var baseMember = filter.Member;
            //bool isMemberChildProperty = filter.Member.Contains(".");
            //if (isMemberChildProperty)
            //{
            //    var splitOffMembers = filter.Member.Split('.');
            //    baseMember = splitOffMembers[0];
            //}

            var propertyInfoMatch = GetNestedProperty(typeof(T), filter.Member); //typeof(T).GetProperty(filter.Member, System.Reflection.BindingFlags.IgnoreCase | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public);
        ...
        // Based off of: https://stackoverflow.com/questions/1954746/using-reflection-in-c-sharp-to-get-properties-of-a-nested-object
        private static PropertyInfo GetNestedProperty(Type src, string propName)
        {
            ...
            if (propName.Contains(".")) // Complex type nested
            {
                ...
                return GetNestedProperty(GetNestedProperty(src, temp[0]).PropertyType, temp[1]);
            }
            else
            {
                return src.GetProperty(propName, System.Reflection.BindingFlags.IgnoreCase | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public);
            }
        }
