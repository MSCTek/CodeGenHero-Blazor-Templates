...
using xDTO = ArtistSiteAAD.Shared.DTO;
	...
	public partial class WebApiDataServiceAS : WebApiDataServiceBase, IWebApiDataServiceAS
	{
		...
		public async Task<IHttpCallResultCGHT<IPageDataT<IList<xDTO.Artist>>>> GetArtistsAsync(IPageDataRequest pageDataRequest)
		{
				...
				var retVal = await SerializationHelper.SerializeCallResultsGet<IList<xDTO.Artist>>(
					Log, await GetHttpClientAsync(), requestUrl,
					filter: filter,
		...
		{
				var retVal = await SerializationHelper.SerializeCallResultsGet<xDTO.Artist>(Log, await GetHttpClientAsync(),
		...
		{
				var retVal = await SerializationHelper.SerializeCallResultsGet<xDTO.Artwork>(Log, await GetHttpClientAsync(),
		...
		{
				var retVal = await SerializationHelper.SerializeCallResultsGet<xDTO.ArtworkCategoryXref>(Log, await GetHttpClientAsync(),
		...
		{
				var retVal = await SerializationHelper.SerializeCallResultsGet<xDTO.ArtworkMediumXref>(Log, await GetHttpClientAsync(),
		...
		{
				var retVal = await SerializationHelper.SerializeCallResultsGet<xDTO.Category>(Log, await GetHttpClientAsync(),
		...
		{
				var retVal = await SerializationHelper.SerializeCallResultsGet<xDTO.Medium>(Log, await GetHttpClientAsync(),
		...
		{
				var retVal = await SerializationHelper.SerializeCallResultsGet<xDTO.NewsItem>(Log, await GetHttpClientAsync(),
